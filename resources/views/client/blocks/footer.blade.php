    ...
    <div class="row px-xl-5 pt-5">
        ...
        <div class="col-lg-8 col-md-12">
            <div class="row">
                ...
                {{-- <div class="col-md-6 mb-5">
                    <h5 class="font-weight-bold text-dark mb-4">Nhận thông tin ưu đãi mới nhất</h5>
                    <form action="">
                        ...
                        <div class="form-group">
                            <input type="email" class="form-control border-0 py-4" placeholder="Email nhận thông tin"
                                required="required" />
                        </div>
                        <div>
