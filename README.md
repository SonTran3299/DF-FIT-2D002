...
- Product Management: Full CRUD (Create, Read, Update, Delete) functionality for books, integrated with SQL database.

- Shopping Cart: Real-time cart management for users.
  
- Checkout Process: Integrated basic user checkout workflow.
...
```sh
git clone https://github.com/Son-Tran3299/DF-FIT-2D002.git
```
